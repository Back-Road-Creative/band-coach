...
//
// Deliberately unchanged from the original: same thresholds (0.008 rms
// floor, 0.15 / 0.3 clarity cutoffs), same O(window * lag) autocorrelation.
//
...
export function yin(buf, sr, fmin, fmax) {
