// Wiring: computeOnsetEnvelope(pcm, sampleRate, opts) takes plain mono Float32Array PCM
// (decoding happens elsewhere) and returns { envelope: Float32Array, hopSeconds }. Feed the
// envelope straight into tempo.js's estimateTempo/trackBeats.
...
// increases in log(1+magnitude) across frequency bins. Standard onset-detection function
// (Dixon 2006 / Ellis 2007 style rectified spectral flux).
