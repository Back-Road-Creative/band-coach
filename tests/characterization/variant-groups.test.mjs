...
const KNOWN_VARIANT_PARENTS = { 'bass-5-string': 'bass', 'ukulele-low-g': 'uke', 'ukulele-baritone': 'uke', 'trumpet-bb': 'wind', 'horn-f': 'wind', trombone: 'wind', viola: 'violin', cello: 'violin', 'double-bass': 'violin', 'recorder-descant': 'wind', 'tin-whistle': 'wind', flute: 'wind', 'clarinet-bb': 'wind', oboe: 'wind', 'sax-alto-eb': 'wind', 'sax-tenor-bb': 'wind' };
